 ...
 */
#define MY_DEFAULT_HOST_NAME			MY_HOST_NAME

#define MY_DEFAULT_MAC_BYTE1            MY_MAC_BYTE1
#define MY_DEFAULT_MAC_BYTE2            MY_MAC_BYTE2
#define MY_DEFAULT_MAC_BYTE3            MY_MAC_BYTE3
#define MY_DEFAULT_MAC_BYTE4            MY_MAC_BYTE4
#define MY_DEFAULT_MAC_BYTE5            MY_MAC_BYTE5
#define MY_DEFAULT_MAC_BYTE6            MY_MAC_BYTE6

#define MY_DEFAULT_IP_ADDR_BYTE1        MY_IP_ADDR_BYTE1
#define MY_DEFAULT_IP_ADDR_BYTE2        MY_IP_ADDR_BYTE2
#define MY_DEFAULT_IP_ADDR_BYTE3        MY_IP_ADDR_BYTE3
#define MY_DEFAULT_IP_ADDR_BYTE4        MY_IP_ADDR_BYTE4

#define MY_DEFAULT_MASK_BYTE1           MY_MASK_BYTE1
#define MY_DEFAULT_MASK_BYTE2           MY_MASK_BYTE2
#define MY_DEFAULT_MASK_BYTE3           MY_MASK_BYTE3
#define MY_DEFAULT_MASK_BYTE4           MY_MASK_BYTE4

#define MY_DEFAULT_GATE_BYTE1           MY_GATEWAY_BYTE1
#define MY_DEFAULT_GATE_BYTE2           MY_GATEWAY_BYTE2
#define MY_DEFAULT_GATE_BYTE3           MY_GATEWAY_BYTE3
#define MY_DEFAULT_GATE_BYTE4           MY_GATEWAY_BYTE4

#define MY_DEFAULT_PRIMARY_DNS_BYTE1	MY_PRIMARY_DNS_BYTE1
#define MY_DEFAULT_PRIMARY_DNS_BYTE2	MY_PRIMARY_DNS_BYTE2
#define MY_DEFAULT_PRIMARY_DNS_BYTE3	MY_PRIMARY_DNS_BYTE3
#define MY_DEFAULT_PRIMARY_DNS_BYTE4	MY_PRIMARY_DNS_BYTE4

#define MY_DEFAULT_SECONDARY_DNS_BYTE1	MY_SECONDARY_DNS_BYTE1
#define MY_DEFAULT_SECONDARY_DNS_BYTE2	MY_SECONDARY_DNS_BYTE2
#define MY_DEFAULT_SECONDARY_DNS_BYTE3	MY_SECONDARY_DNS_BYTE3
#define MY_DEFAULT_SECONDARY_DNS_BYTE4	MY_SECONDARY_DNS_BYTE4
