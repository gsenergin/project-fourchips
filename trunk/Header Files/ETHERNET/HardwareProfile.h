...
//	#define ENC100_INTERFACE_MODE			%ENC100_INTERFACE_MODE%
//
...
//	%ENC100_BIT_BANG_PMP%#define ENC100_BIT_BANG_PMP
...
//	%MRF24WB0M_IN_SPI1%#define MRF24WB0M_IN_SPI1
//	%MRF24WB0M_IN_SPI2%#define MRF24WB0M_IN_SPI2
//	
...
//	%EXTRA_ENC28J60_COMMENT_FOR_PICDEMNET2%#define ENC_CS_TRIS			(TRISDbits.TRISD3)	// Uncomment this line if you wish to use the ENC28J60 on the PICDEM.net 2 board instead of the internal PIC18F97J60 Ethernet module
...
//	%EXTRA_ENC28J60_COMMENT_FOR_PICDEMNET2%#define ENC_CS_TRIS			(TRISD3)	// Uncomment this line if you wish to use the ENC28J60 on the PICDEM.net 2 board instead of the internal PIC18F97J60 Ethernet module
...
// Define your own board hardware profile here
	...
	#define ENC_RST_IO			(LATBbits.LATB5)
	#define ENC_CS_TRIS			(TRISAbits.TRISA5)	// Uncomment this line to use the ENC28J60 Ethernet controller or comment it out to use some other network controller
	#define ENC_CS_IO			(PORTAbits.RA5)
	#define ENC_SCK_TRIS		(TRISCbits.TRISC3)
	#define ENC_SDI_TRIS		(TRISCbits.TRISC4)
	#define ENC_SDO_TRIS		(TRISCbits.TRISC5)
	#define ENC_SPI_IF			(PIR1bits.SSP1IF)
